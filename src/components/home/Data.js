...
const Data = () =>{
    return(
        <div className="home__data">
            <h1 className="home__tittle">Agustin Saraspe
            {/* <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className="home__description">A passionate fullstack developer from Argentina, with a preference for the backend but with a strong interest in the frontend and I always like to keep learning new technologies</p>

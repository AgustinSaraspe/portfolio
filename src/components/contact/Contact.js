...
const Contact = () =>{
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_2htkl8c', 'template_6fhm7jo', form.current, 'Gzc-OQZd_jLpyoDlb')
     e.target.reset()
    };
                ...
                <div className="contact__content">
                   ...
                   <div className="contact__info">
                    ...
                    <div className="contact__card">
                         ...
                         <a href="mailto:agus.saraspe03@gmail.com.com" className="contact__button">Write me <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div>

                    <div className="contact__card">
                         <i className="bx bxl-whatsapp contact__card-icon"></i>
                         <h3 className="contact__card-title">Whatsapp</h3>
                         <span className="contact__card-data">3863694897</span>
                    ...
                    <div className="contact__card">
                         ...
                         <span className="contact__card-data">user.asda</span>
